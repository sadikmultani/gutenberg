...
async function toggleGlobalStyles() {
	await page.click(
...
async function globalStylesNavigatePrevious() {
	await page.click( 'button[aria-label="Navigate to the previous view"]' );
}
...
describe( 'Global styles variations', () => {
	...
	it( 'Should apply preset colors and font sizes in a variation', async () => {
		...
		await globalStylesNavigatePrevious();
